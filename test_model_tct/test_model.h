...
typedef struct {
  ...
  real_T Plus1;                        /* '<Root>/Plus1' */
  real_T FromWorkspace2;               /* '<Root>/From Workspace2' */
  int32_T ErrId;                       /* '<Root>/TC ADS Sync Write' */
  uint8_T TmpSignalConversionAtTCADSSyncW[6];
  boolean_T Err;                       /* '<Root>/TC ADS Sync Write' */
} B_test_model_T;
...
typedef struct {
  ...
  void *TCADSSyncWrite_PWORK[2];       /* '<Root>/TC ADS Sync Write' */
  struct {
    int_T PrevIndex;
  ...
  int_T TCADSSyncWrite_IWORK[6];       /* '<Root>/TC ADS Sync Write' */
} DW_test_model_T;
